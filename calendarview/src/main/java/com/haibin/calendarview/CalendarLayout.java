...
//    private static final int GESTURE_MODE_ONLY_CALENDAR = 1;
    ...
    void updateContentViewTranslateY() {
        ...
        if (mDelegate.getMonthViewShowMode() == CalendarViewDelegate.MODE_ALL_MONTH) {
            ...
            mContentViewTranslateY = CalendarUtil.getMonthViewHeight2(calendar.getYear(),
                    calendar.getMonth(), mItemHeight, mDelegate.getWeekStart(), mDelegate.getCalendarPaddingBottom())
                    - mItemHeight;
        }
    ...
    final void updateCalendarItemHeight() {
        ...
        if (mDelegate.getMonthViewShowMode() == CalendarViewDelegate.MODE_ALL_MONTH) {
            ...
            mContentViewTranslateY = CalendarUtil.getMonthViewHeight2(calendar.getYear(), calendar.getMonth(),
                    mItemHeight, mDelegate.getWeekStart(), mDelegate.getCalendarPaddingBottom()) - mItemHeight;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int monthHeight = CalendarUtil.getMonthViewHeight(year, month,
                ...
                mDelegate.getCalendarPaddingBottom())
                + weekBarHeight;
